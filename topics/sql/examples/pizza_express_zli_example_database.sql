DROP DATABASE IF EXISTS pizza_express_zli_example;
CREATE DATABASE pizza_express_zli_example;
...
ALTER TABLE product
    CHANGE product_name name VARCHAR(255) NOT NULL;

-- Ändern Sie den Datentyp des Produktpreises auf DECIMAL(6,2) UNSIGNED
ALTER TABLE product
    MODIFY price DECIMAL(6, 2) UNSIGNED;
...
ALTER TABLE customer
    ADD FOREIGN KEY (fk_zip_id) REFERENCES zip (id);
...
INSERT INTO customer (fk_zip_id, firstname, lastname, address, email, password, phone)
VALUES (2, 'Hans', 'Muster', 'Nordstrasse 1', 'hans@muster.com', SHA('insecure'), '044 123 45 67'),
...
VALUES (1, 'Margherita', 'Tomaten, Mozzarella', 17.00),
...
VALUES (2, CURRENT_TIMESTAMP - INTERVAL 5 DAY, CURRENT_TIMESTAMP - INTERVAL 3 DAY),
